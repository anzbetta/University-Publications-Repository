...
export function AuthorDashboard({ publications, onCreateNew, onViewDetails }: AuthorDashboardProps) {
    ...
    <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
      <div className="mb-8">
        <div className="flex justify-between items-center mb-6">
          <div>
            <h2 className="text-gray-900 mb-2">My Publications</h2>
            <p className="text-gray-600">Manage and track your scientific publication submissions</p>
          </div>
          <button
            onClick={onCreateNew}
              ...
              {publications.length === 0 ? (
                <tr>
                  <td colSpan={6} className="px-6 py-8 text-center text-gray-500">
                    No publications submitted yet. Click &quot;Create New Submission&quot; to get started.
                  </td>
                </tr>
              ) : (
